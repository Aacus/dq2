fn main() {
    ...
    loop {
        ...
        let mut comm: Vec<&str> = com.splitn(2, ' ').collect();
        comm.push("");
        match comm[0].trim() {
            "" => help(),
...
fn mu(ex: i32, lv: i32) {
    ...
    match lv {
        ...
        21 => stm(21, 124, 138, 23, 100, "トラマナ", 150000, ex),
        22 => stm(22, 133, 140, 25, 110, "", 180000, ex),
        23 => stm(23, 140, 151, 29, 117, "アバカム", 220000, ex),
        24 => stm(24, 145, 158, 33, 117, "", 270000, ex),
        25 => stm(25, 146, 163, 35, 120, "", 300000, ex),
